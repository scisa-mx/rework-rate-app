  ...
  >
    <TabsList class="flex flex-wrap items-center px-4 gap-2 border-b border-gray-200 relative">
      ...
      <TabsTrigger
        ...
        class="relative px-4 py-2 text-sm font-medium text-gray-600 data-[state=active]:text-gray-800 data-[state=active]:border-b-2 data-[state=active]:border-royal-purple-500 hover:bg-gray-50 focus:outline-none focus-visible:ring data-[disabled]:text-gray-500 data-[disabled]:bg-gray-50 focus-visible:ring-blue-100"
      >
        {{ trigger.title }}
        <span
